...
void test_CV_Density(CuTest *tc) {
    ...
    char *buzz[KEYWORD_LENGTH] = {"netto",
                                  ...
                                  "machinelearning",
                                  "Bsc",
                                  "Software"};  // testing, tb replace by read.c
    int length[PARA_AMOUNT] = {5, 5, 6, 10,
                               6, 7};  // length of each individuel paragraph
                                       // //testing, tb replace by read.c
    ...
    printf("Test: 1: %lf 2: %lf 3: %lf 4: %lf 5: %lf 6: %lf \n",
           density_of_Paragraph[0], density_of_Paragraph[1],
           density_of_Paragraph[2], density_of_Paragraph[3],
           density_of_Paragraph[4], density_of_Paragraph[5]);
