...
As discussed in background(Unemployment rates), Denmark, a small and generally economically robust country, has 137800 unemplyed according to the newest figures. 
...
This means that formating your CV correctly to appease the scanning systems could make an essential difference in an applicants hunt for a job.
