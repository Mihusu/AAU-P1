...
Sorting a CV is an important factor, this is partly due to having the CV to at least getting through the qualifying test also known as (ATS).
Both keyword matching and formatting are essential to pass this test.
Formatting is not only the structure of the paragraph itself, it is also the structure of the content in the CV.
Formatting a CV is to state relevant information in a structured and practical layout. 
This also includes the file of the CV, the most popular being as a pdf file.
