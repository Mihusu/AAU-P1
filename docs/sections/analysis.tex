...
As outlined in \ref{Obtaining a Job and The Process of Applying For a Job}, four types of job searchers exist; unemployed searchers, active searchers, employed tiptoers and employed passive.
...
As outlined in \ref{Obtaining a Job and The Process of Applying For a Job} the process of obtaining a job has five stages.
...
As discussed in Background \ref{ATS Scanner and Hiring Personnel}, to obtain a job an applicant is required to pass the ATS scanner and hiring personnel.
...
Firstly, as outlined in Background \ref{ATS Scanner and Hiring Personnel}, the ATS scanner scans for three underlying elements in an applicant's CV.
...
As outlined in Background \ref{ATS Scanner and Hiring Personnel}, three concepts largely determine the chances of passing the hiring personnel.
...
\subsection{Why a Software Solution}
...
\subsection{Narrowing the analysis}
