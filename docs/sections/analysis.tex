...
According to the majority of studies, most hiring personnel spend 5 to 9 seconds (depending on the study) considering an applicants CV, if the CV does not appeal in this small time frame, the application will be rejected.
...
As stated before the structure of a CV fluctuates from application to application.
However if a overall structure based on the position of content could be found, it would make the process of producing a CV with good structure straightforward.


The production of a CV is arguably first thing hiring personnel will notice. 
The way in which a CV is produced is meaningful as it 
