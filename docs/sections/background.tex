...
All countries are built on there population producing value. 
In an utopia all citizens of a each society would produce value enough to cover themselves and a little more for the structures of there society.
However, in reality the value of each citizens production fluctuate. 
Some citizens are hyper-active and produce immense value for there society.
While in every corner of the world, members who produce little to nothing are also found. 
In the modern economic infrastructure these citizens are known as those that are "unemployed".
But what exactly is unemployment and how does it materialize?

Unemployment occurs when a person who is available and actively searching for employment is unable to find work. (https://www.investopedia.com/terms/u/unemployment.asp)
...
Secondly, to be actively searching entails that the person have actively looked for work in the prior four weeks. (https://www.bls.gov/cps/cps_htgm.htm#concepts)
...
\begin{itemize}
   ...
   \item  Seasonal unemployment unemployment
   \end{itemize} (https://inflateyourmind.com/macroeconomics/unit-4/section-4-types-of-unemployment-and-the-definition-and-significance-of-full-employment/)
Structural unemployment occurs if there is a mismatch between offered and demanded skills.
This could be a lack of demand for workers of a certain skill set, or an excess supply of a job with a lack for workers with matching skill set.
...
This is the biggest cause of unemployment and can have significant consequences on unemployment globally.
...
It is fairly predictable in most cases and often requires workers to find another occupation for the rest of the year. (https://www.investopedia.com/terms/u/unemployment.asp) (https://corporatefinanceinstitute.com/resources/knowledge/economics/unemployment/)
...
A more economical method would conclude that unemployment could materialize "from both demand side, or employer, and the supply side, or the worker." (https://corporatefinanceinstitute.com/resources/knowledge/economics/unemployment/)
Now, it has been discussed how unemployment materializes through the four types of unemployment.

\subsubsection{Unemployment rates and the effect of unemploymenmt on the unemployed}


Every unemployed individual is affected differently by there unemployment.
However, some general trends can be seen when looking at the time frame of unemployment.
To gain an understanding of the effect of unemployment on the unemployed and 
