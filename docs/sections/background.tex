...
It states that "A Philips curve illustrates a tradeoff between thse unemployment rate and the inflation rate; if one is higher, the other must be lower." \cite{Economics_Philips_Curve}
