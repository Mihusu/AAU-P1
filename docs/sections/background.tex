...
The process of applying to a job and how the ATS scanner and hiring personnel screen an applicants CV has been discussed.
As discussed, the structure and content is crucial to passing the hiring personnel.
However, a CV´s content and definition is not yet defined, it must include something to be considered a CV, but what could it situationally contain based on applicant.
...
As discussed, hiring personnel first impression is based on the structure and content.
The required and situational content of a CV has been discussed.
Therefore, the possible structures of a CV is vital for the applicants to understand and use correctly in there CV´s.
So, what are the possible structures of an applicants CV?

Writing an effective CV isn´s just about including the right content. 
