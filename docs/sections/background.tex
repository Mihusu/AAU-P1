...
The process of applying for a job has four main stages.
These four stages are most relevant to those who apply through CV, the most likely method of application.
The four stages all have a obstacle that if passed 
