...
\incfigure{figures/United_States_Growth_Rate(GNP)_and_Unemployment_Rate}{fig:rate_US}{Unemployment and Growth rate \cite{US_Unemployment}\cite{US_Growth_Rate_GNP}}
...
\begin{enumerate}
   \item 1. Applying through CV to job position.
   \item 2. ATS scanner scans your CV.
   \item 3. Hiring personnel view you CV.
   \item 4. Job interview with firm/organization.
   \item 5. Job offer.
\end{enumerate}
Each stage merits a discussion of the obstacle it presents.
The first stage "Applying through CV to job position" is the first stage, in which the applicant sends a CV.
The CV is thereafter scrutinized by the the second and third stage and is eith
