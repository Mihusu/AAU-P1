...
\cite{Difference_between_resume_and_curriculum_Vitae}
...
\cite{Difference_between_resume_and_curriculum_Vitae}
\cite{Job_Application_for_science}
...
However, if a CV has the right references 
it can assure employers of your qualifications and past experience.\cite{Professional_associations_and_organizations}\cite{Perks_of_professional_organizations}
