...
\hherror*{Grammatisk uforståeligt, bøjningsfejl, kommatering, danglish}{Often companies have different expectations for structures and information's about the CV, so it will be relevant for the application.
...
\hhwarning*{Grammatisk uforståeligt, tidsfejl, kommatering, danglish}{Research have also revealed that the most popular sentence for writing a CV can get it easier to get a job in IT-companies.
...
\hhwarning*{Grammatisk uforståeligt, tidsfejl, kommatering, danglish}{In the situation of the contents and the document setup, there can be often of those different kind of setups,
...
\hhwarning*{Grammatisk uforståeligt, tidsfejl, kommatering, danglish}{Even though that applicants have wrote a good CV and they have used some good words to describe themselves,
