...
Unemployment differs from country to country, therefore it could be helpful to narrow the discussion down to two countries, USA and Denmark.
This two countries are optimal as they are both relatively stable and reliable in there unemployment numbers and statistics.
Furthermore, USA is the most populated western country, while Denmark is a robust but small country, giving contrast within comparably similar socio-economic structured countries.
Similarly discuss the effect on all individuals on these two countries would have to be general and full of assumptions.
Therefore, let 

Measuring unemployment in itself is a complex endeavour and is prone to error and bias.
Nonetheless, to gain an understanding of unemployment in every country it is essential to 
