...
if a keyword is matching any works in a sentence,
at the same time to help the include section function for running with boolean values, 
and afterwards these selected text will be generated by generate text.
In the last part of the filter function in the CV LaTeX file by using a function 
