...
\incfigure{figures/engMVP}{fig: Minimal Viable Product}{MVP}
...
\incfigure{figures/Program_process_diagram}{fig: Revised Minimal Viable Product}{Revised MVP} \newline
...
\begin{figure}[ht]
  \centering
  \includegraphics[height=6cm]{figures/is_match}
