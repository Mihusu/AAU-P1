...
\incfigure{figures/is_match}{fig: Is match flow diagram}{Flow diagram of word_matching}
...
\incfigure{figures/section_density}{fig: density function}{Density & weight function}
...
To demonstrate that the functions work, it can be seen that both line 8 & 9 gets printet with a result of exactly 1.
...
\incfigure{figures/include_function}{fig: inclusion function}{Inclusion Function}
