...
\aautitlepage{%
  ...
  The feedback concluded that structure and contents were essential to get a good result and only one of them did the program succeed in.
  Lacking the adequate capabilities to structure CV as fluently as a human, might deter the hiring personal, 
  and it has poor success at passing the ATS scanner.
  These results indicate that the project's objective was not fully meet.