...
\aautitlepage{%
  ...
  there is still a good chance of being rejected by all of them.
  ...
  To test the hypothesis that a human-made CV can be rejected by hiring personnel, 
  a job counselor will check one CV from a human and 15 different CVs from a computer with 15 different job postings,
  and compare them which of these are the best for the specific job position. 
  The result showed structure and contents were essential to get a good result and only one of them did the program succeed in, 
  therefore the direction for the hypothesis was almost there of getting passed hiring personnel still the ATS scanner was a success 
  because of the final product. 
}}